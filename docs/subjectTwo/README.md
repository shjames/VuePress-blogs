...
*   追道路右侧黄线：
    ...
    *   **其他项目**：雨刮最右侧凸点追黄线**外线**。
    *   **注意**：下次训练需确认追外线是否有压线风险。坡道停车后，右车身距离黄线 0-30cm 不扣分，30-50cm 扣10分，大于50cm 扣100分。
...
*   **追线**：
    *   雨刮最右侧凸点压黄线**外线**去追（**需再次确认**是否在0-30cm，是否有压线风险）。
    *   追到坡底准备上坡时，追右往左数，第二和第三条虚线中间。
*   **上坡操作**：
    *   上坡道的过程中停车**不能动离合**，只能踩脚刹。
    *   **停车点位**（一定要坐直坐正，车速要慢）：左后视镜下沿超中间粗线（约两条普通虚线宽）一半（即一条普通虚线）时迅速脚刹踩死停车。
    *   拉一半手刹（不能拉满）3秒，放手刹，松脚刹，车走后脚刹松完。
*   **下坡操作**：
    *   离合踩死（断掉动力传输），让车惯性前行。
    *   下坡过程靠脚刹控速。
*   **下坡第一个点位**（正常考试下坡的过程已经考试结束了，下坡不算坡道考试范围了）：雨刷压黄线左一圈，人正回正，然后追线。

#### 二、曲线、直角重点

*   **第一个直角位**（训练场特定，考试可能没有，反正遇到直角要转弯都是一样的以梦把手后边缘作为打死的点位）：
    *   车把手后边缘（训练时粉笔标记处，需练习无标记情况）与直角平行时，左打死（其实就是直角转弯）。
    *   雨刷即将压黄线时回正（平行看雨刷，压侧库第一条平行线）。

*   **准备进入曲线**：
    *   雪糕桶对准肩膀，左打一圈（侧方停车出来后的第一个点位）。
    *   车头压黄线回正，**立马右打死**。
    *   进入曲线中间回正（回正可以参考下面图片说明）。
*   **曲线行驶**：
...
*   **坡道刚上坡时**：方向盘**左带45度**（不是90度（1/4圈））两秒钟（因车上坡会自动右偏），然后回正。
*   **坡道停车后再启动**：方向盘也要**左带45度**，1秒回正，防止右边压线。
