...
### <span style="color:red;">不管遇到什么情况、任何情况 ，第一心里暗示就是：不要慌，先平静下来，先冷静下来</span>

### <span style="color:red;">考试慌也要考,不慌也要考,而且一慌考试肯定挂，那么为什么要慌呢？</span>

### <span style="color:red;">考试在心里预告下一步的项目及操作时，也一定要看清楚每一个红绿灯，绿灯才能走，并且要点刹</span>

### <span style="color:red;">考试时候千万不要想着挂科了怎么办，应该想着怎么把练习的东西完美得做出来，也就是照做，心里想着考试路线，下一步应该做的事情，千万不要想与考试无关的东西，一定要相信自己能过的</span>

### <span style="color:red;">每次停车后，都要问自己，停下来目的是啥？该操作啥？比如停车准备进入靠边停车，就一定要记住打右转向灯</span>

### <span style="color:red;">每次停车起步后，都要记得尽快上二挡</span>
...
- **4号线:直走（自主左变一条道）**：4号线做完直线行驶有条件，就可以开始提前打左灯变到最左车道了，因为接下来的项目是左掉头
...
- **起步第一个右转路口**：一开始出来路口时，尽量停两次车重新起步（前面没车不停的话，一定要记得在黄色箭头处点刹）。
  ...
  - **第二次**：右转完，过来后的雪糕桶（6）、实线尽头处（4），都需要停车重新一档起步。只不过4号线要注意一下，实线尽头处有一个小坡度，尽量不要把车停到坡度上，避免增加重新起步的难度，都是为了一档不超50m。
...
## 七、考试通用注意事项
- **补灯**：要打灯的地方，要留意灯有没有亮着，如果掉灯了记得补回去。
...
- <span style="color:red;">**离合控制方法**：和离合接触的位置一定是脚尖，一定不能用脚肚去接触，找半联动的时候，抖动的感觉不要给太强，除了4号线坡道起步那里，其他地方都是平地，给的不够，最多再松一点点，但是不会熄火、不会溜车，因为考试车第一次接触，不知道离合的感觉，一上来给太松，怕直接熄火。总结就是：如果是4号线坡道起步，抖动感觉可以给强烈一点，其他地方，只有稍有抖动的感觉就够了</span>
### 2. 考试心态与操作
